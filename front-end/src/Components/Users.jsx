  ...
  return (
    <div class="">
      <div class="flex justify-evenly items-center ">
        <div className="">
          <h1 className="font-bold md:text-2xl text-md">MANEJO DE USUARIOS</h1>
        </div>
        <div className=" ">
      ...
      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          <tr class="text-center px-6 py-4 bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            <td>Sliver Ortega Diaz</td>
            <th> silver@gmail.com</th>
            <td class="">614-155-88-88</td>
            <td class="">Administrador</td>
            <td class="">
              <a href="#" className="flex justify-center">
                <img className="object-center" src={Edit} alt="Editar" />
              </a>
            </td>
            <td class="">
              <a href="#" className="flex justify-center">
                <img className="w-7" src={Delete} alt="Editar" />
              </a>
            </td>
          </tr>
        </tbody>
