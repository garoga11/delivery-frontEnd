...
export default class RegisterDeliveryman extends React.Component{
    render(){
        return(
            <React.Fragment>
                            ...
                            <div className="grid grid-cols-2 bg-white rounded-[60px] shadow py-28 px-28">
                                <div className="">
                                    ...
                                    <div className="grid grid-rows-5 mt-5">
                                        ...
                                        <div className="">
                                            <input className="bg-gray-200 placeholder:text-black mb-3 h-11 w-72 rounded-md focus:outline-none focus:border-b-2 focus:border-blue-600 " type="text" placeholder="Ciudad" />
                                        </div>
                                        <div className="">
                                        ...
                                        <div className="">
                                            <input className="bg-gray-200 placeholder:text-black mb-3 h-11 w-72 rounded-md focus:outline-none focus:border-b-2 focus:border-blue-600" type="text" placeholder="INE*" required/>
                                        </div>
                                    </div>
                                </div>
                                <div className="ml-4">
                                    <button className="bg-[#F8EA19] rounded-xl text-center h-9 w-44 font-semibold mb-12 ml-20" disabled>REPARTIDOR</button>
                                    <div className="grid grid-rows-4 mt-8">
                                        <div className="">
                                            <input className="bg-gray-200 placeholder:text-black  h-11 w-72  rounded-md focus:outline-none focus:border-b-2 focus:border-blue-600 " type="text" placeholder="Apellidos*" required/>
                                        </div>
                                        <div className="">
                                        ...
                                        <div className="">
                                            <input className="bg-gray-200 placeholder:text-black mt-1 h-11 w-72 rounded-md focus:outline-none focus:border-b-2 focus:border-blue-600 " type="text" placeholder="RFC (cedula fiscal)*" required/>
                                        </div>
                                        <div className="">
                                            <input className="bg-gray-200 placeholder:text-black mt-2 h-11 w-72 rounded-md focus:outline-none focus:border-b-2 focus:border-blue-600 " type="text" placeholder="CURP*" required/>
                                        </div>
                                    </div>
                                </div>
